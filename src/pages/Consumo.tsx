...
export function Consumo() {
  ...
  return (
    <div>
      <PageHeader
        title="Consumo"
        subtitle="Volume, gasto e KM/L por Gerência (Centro de Custo)"
      />

      <Card title="Consumo por Gerência" subtitle="Ordenado por gasto · ponderação de KM/L pelos litros consumidos">
        {linhas.length === 0 ? (
          <EmptyState />
        ) : (
          <>
